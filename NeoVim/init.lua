...
--  See `:help 'clipboard'`
-- IMPORTANT! ----------------------------------------------------------------------
-- switch between clipboard for non wsl os
...
end, { desc = 'Goto flaoting diagnostic' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>st', builtin.live_grep, { desc = '[Search [T]ext' })
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- powershell_es = {
        --   bundle_path = 'c:/repos/tools/PowerShellEditorServices',
        -- },
        -- markdown_oxide = {},
        prettier = {},
        terraformls = {},
        ...
        roslyn = {},
        -- denols = {
        --   root_markers = { 'deno.json', 'deno.jsonc', 'tsconfig.json' },
        -- },
        -- omnisharp = {},
      }
