local function lsp_config(servers, others)
  return {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ld', vim.lsp.buf.hover, 'Show [D]ocumentation')
          -- map('gp', vim.lsp.buf.definition, 'Go to containing declaration')
          map('<leader>o', require('telescope.builtin').lsp_document_symbols, 'Open Document Symbols (Rider FileStructurePopup)')
          map('<leader>sl', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Open Workspace Symbols')
      ...
      vim.list_extend(ensure_installed, others)
      require('mason').setup {
        registries = {
